...
- `core/control/g1d_agv_bridge.py`：G1D AGV 底盘桥
...
## 5.12 `core/control/g1d_agv_bridge.py`

这个包是一个 **Python -> C++ bridge**。

### 关键函数/方法
- `build_g1d_agv_bridge()`：用 g++ 编译 `core/control/cpp/g1d_agv_bridge.cpp`
...
1. `teleop/real/teleop_hand_and_arm.py`

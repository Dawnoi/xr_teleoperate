...
class CollisionAvoidanceLimit(Limit):
    ...
    def compute_qp_inequalities(
        ...
        del dt  # The QP variable is a configuration displacement, not velocity.
        ...
        for idx, (geom1_id, geom2_id) in enumerate(self.geom_id_pairs):
            ...
            if hi_bound_dist > self.minimum_distance_from_collisions:
                ...
                # The QP decision variable in build_ik is a configuration
                # displacement dq (VelocityLimit likewise bounds it by dt*vmax),
                # so the collision-distance bound is a displacement as well.
